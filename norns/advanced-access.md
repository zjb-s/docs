...
**If your [hostname](https://monome.org/docs/norns/wifi-files/#hostname) isn't `norns`, remember make the appropriate substitution for all commands in this section!*
